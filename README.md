...
- [Ansible CCNA lab](#ansible-ccna-lab)
...
- [display_ok_hosts=no](#displayokhostsno)
- [display_skipped_hosts=no](#displayskippedhostsno)
...
- [method=modules # modules or templating not yet implemented](#methodmodules-modules-or-templating-not-yet-implemented)
- [routing_ipv4='["rip", "eigrp4", "ospfv2"]'](#routingipv4rip-eigrp4-ospfv2)
- [routing_ipv6='["eigrp6", "ospfv3"]'](#routingipv6eigrp6-ospfv3)
