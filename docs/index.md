...
* L'exécution des rôles est conditionnée par :
  ...
  * le protocole de routage dynamique est contrôlé à partir du livre de jeu avec les variables `ipv4.routing` et `ipv6.routing`. Il est conseillé d'en activer un seul pour une topologie. Des cas de "route redistribution" devraient être envisagés.
